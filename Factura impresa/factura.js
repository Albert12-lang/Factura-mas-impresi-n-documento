...
const productos = [
        ...
        // Referencia al botón de imprimir / PDF
        const btnImprimir = document.getElementById('id-btn-imprimir')
...
// Se encarga de abrir el diálogo de impresión del navegador.
// Desde ahí el usuario puede elegir "Guardar como PDF" como destino.
